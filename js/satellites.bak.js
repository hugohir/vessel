...
var E113WA_FP = L.geoJSON(Eutelsat113W_Footprint, {weight: 0.2,
    style: function(feature) {
        switch (feature.properties.footprint) {
          case 'E113WA_Footprint_PanAmerica_Cband3_42dBW_North': return {fillColor: "#0077b3", fillOpacity:0.3,color: "#004466"};
          case 'E113WA_Footprint_PanAmerica_Cband3_40dBW_South': return {fillColor: "#0077b3", fillOpacity:0.1,color: "#004466"};
          case 'E113WA_Footprint_PanAmerica_Cband3_41dBW_North': return {fillColor: "#0077b3", fillOpacity:0.2,color: "#004466"};
          case 'E113WA_Footprint_PanAmerica_Cband3_40dBW_North': return {fillColor: "#0077b3", fillOpacity:0.1,color: "#004466"};
          case 'E113WA_Footprint_PanAmerica_Cband3_41dBW_South': return {fillColor: "#0077b3", fillOpacity:0.2,color: "#004466"};
          case 'E113WA_Footprint_PanAmerica_Cband3_38dBW_Americas': return {fillColor: "#0077b3", fillOpacity:0.05,color: "#004466"};
          case 'E113WA_Footprint_PanAmerica_Cband3_39dbW_Americas': return {fillColor: "#0077b3", fillOpacity:0.05,color: "#004466"};
          }}});

var E113WA_EV = L.geoJSON(Eutelsat113W_Elevation, {weight: 0.3,
    style: function(feature){
        switch (feature.properties.elevation){
          case 'Eutelsat113W_Elevation_10': return {fillColor: "#990099",fillOpacity: 0, color: "#000000"};
          case 'Eutelsat113W_Elevation_5': return {fillColor: "#990099", fillOpacity: 0, color: "#000000"};
          case 'Eutelsat113W_Elevation_0': return {fillColor: "#990099",fillOpacity: 0, color: "#000000"};
          }}});
...
var AnikF1R_FP = L.geoJSON(AnikF1R_Footprint, {weight: 0.2,
  style: function(feature) {
      switch (feature.properties.footprint){
        ...
        case 'AnikF1R_Footprint_38dBW': return {fillColor: "#ff33ff", fillOpacity:0.1,color:"#800080"};
...
var ABS3A_FP_345 = L.geoJSON(ABS3A_Footprint_345, {weight: 0.3,
    style: function(feature) {
              switch (feature.properties.footprint){
                case 'ABS3A_Footprint_34.5dBW': return {fillOpacity: 0.01, fillColor: "#e6b800", color: '#4d3d00'};
              }}});
